...
<table cellpadding="0" cellspacing="0" width="100%" class="pm-add-tables">
  ...
  <tr>
    ...
    if(!FlashDetect.installed){
      document.write('<?php echo pm_alert_warning("<strong>Adobe Flash</strong> is required for video uploading.<br />Please <a href=\"https://helpx.adobe.com/flash-player.html\" target=\"_blank\">visit the official Adobe Flash website</a> to install Flash."); ?>');
    }
    </script>
