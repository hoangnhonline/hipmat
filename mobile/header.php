...
<!-- New favicon -->
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no,target-densitydpi=medium-dpi;"/>
<link rel="apple-touch-icon" sizes="57x57" href="<?php echo _URL_MOBI; ?>/favicon/apple-touch-icon-57x57.png">
<link rel="apple-touch-icon" sizes="60x60" href="<?php echo _URL_MOBI; ?>/favicon/apple-touch-icon-60x60.png">
<link rel="apple-touch-icon" sizes="72x72" href="<?php echo _URL_MOBI; ?>/favicon/apple-touch-icon-72x72.png">
<link rel="apple-touch-icon" sizes="76x76" href="<?php echo _URL_MOBI; ?>/favicon/apple-touch-icon-76x76.png">
<link rel="apple-touch-icon" sizes="114x114" href="<?php echo _URL_MOBI; ?>/favicon/apple-touch-icon-114x114.png">
<link rel="apple-touch-icon" sizes="120x120" href="<?php echo _URL_MOBI; ?>/favicon/apple-touch-icon-120x120.png">
<link rel="icon" type="image/png" href="<?php echo _URL_MOBI; ?>/favicon/favicon-32x32.png" sizes="32x32">
<link rel="icon" type="image/png" href="<?php echo _URL_MOBI; ?>/favicon/favicon-96x96.png" sizes="96x96">
<link rel="icon" type="image/png" href="<?php echo _URL_MOBI; ?>/favicon/favicon-16x16.png" sizes="16x16">
<link rel="manifest" href="<?php echo _URL_MOBI; ?>/favicon/manifest.json">
<link rel="mask-icon" href="<?php echo _URL_MOBI; ?>/favicon/safari-pinned-tab.svg" color="#5bbad5">
...
<?php
//chinh sua by anhtai , detail video on mobile cho index nhung them canonical
	if(isset($video_slug) && isset($unique_id))
	{
		echo "<link rel='canonical' href='"._URL."/".$video_slug[0]."_$unique_id.html'>";
	}
	elseif(isset($video_cat_slug) && isset($cat_id))
		{
			echo "<link rel='canonical' href='"._URL."/browse-".$video_cat_slug[0]."-videos-1-date.html'>";
		}
...
<?php } ?>
  ...
  <a id="cd-menu-trigger" href="#0"><span class="cd-menu-text">Menu</span><span class="cd-menu-icon"></span></a>
  	...
  	<a href="<?php echo _URL_MOBI;?>/index.<?php echo _FEXT;?>"><img src="http://www.hipmat.com/uploads/custom-logo.png"></a>
  	</span>
  </header>
