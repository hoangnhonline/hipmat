...
if($date_diff < _ISNEW_DAYS)
	$listing .= '<span class="is_new">MỚI</span>';
if($video['site_views'] > _ISPOPULAR)
	$listing .= '<span class="is_hot">HOT</span>';
if($video['featured'] == 1)
	$listing .= '<span class="is_featured">CHẤT</span>';
...
function mobi_get_hot_video_list($category_id = 0, $video_title = '', $limit = 5, $video_id = 0)
{
	global $config, $_mobile_supported_sources;
