{if $comment_data.user_id == 0}
	<a href="#" class="pull-left"><img src="{$comment_data.avatar_url}" height="40" width="40" alt="" class="media-object"></a>
{else}
	<a href="{$comment_data.user_profile_href}" class="pull-left"><img src="{$comment_data.avatar_url}" height="40" width="40" alt="" class="media-object"></a>
{/if}
...
<div class="media-body{if $comment_data.user_is_banned} media-body-banned{/if}">
	...
	{/if}
	<div class="media-date">{$lang.added} <time datetime="{$comment_data.html5_datetime}" title="{$comment_data.full_datetime}">{$comment_data.time_since_added} {$lang.ago}</time></div>
