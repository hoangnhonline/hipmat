			...
			<div class="pm-user-brief">
				...
				<div class="nav-responsive">
					<ul class="nav nav-tabs nav-underlined">
						<li><a href="{$smarty.const._URL}/edit_profile.{$smarty.const._FEXT}">{$lang.edit_profile}</a>
						<li><a href="{$smarty.const._URL}/playlists.{$smarty.const._FEXT}">{$lang.manage_playlists|default:'Manage Playlists'}</a></li>
						<li><a href="{$smarty.const._URL}/memberlist.{$smarty.const._FEXT}">{$lang.members}</a></li>
