				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							...
							{/if}
							<hr />
							<input type="text" class="form-control" name="yt_thumb" value="{$video_data.image_url}" placeholder="http://"> 
						</div>
					</div>
					{/if}
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<input type="text" class="form-control" name="direct" value="{$video_data.direct}" placeholder="http://"> 
