<div class="thumbnail{if $thumbSize == 'small'} thumbnail-small{elseif $thumbSize == 'medium'} thumbnail-medium{elseif $thumbSize == 'large'} thumbnail-large{/if}">
	<div class="pm-video-thumb{if $video_data.pending_approval} pm-video-thumb-pending{/if}">
		...
		<a href="{$video_data.video_href}" title="{$video_data.attr_alt}">
			...
			{/if}
			<img src="{$smarty.const._URL}/templates/{$template_dir}/img/echo-lzld.png" alt="{$video_data.attr_alt}" data-echo="{$video_data.thumb_img_url}" class="img-responsive">
