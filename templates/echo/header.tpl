...
<link rel="stylesheet" type="text/css" media="screen" href="{$smarty.const._URL}/templates/{$template_dir}/css/echo.css">
...
<link rel="stylesheet" type="text/css" media="screen" href="{$smarty.const._URL}/templates/{$template_dir}/css/echo.rtl.css">
{/if}
...
<nav id="myNavmenu" class="navmenu navmenu-default navmenu-fixed-left offcanvas" role="navigation">
	<div class="navslide-wrap">
		<ul class="list-unstyled">
			<li class="{if $tpl_name=='index'}nav-menu-item-active{/if}"><a href="{$smarty.const._URL}"><i class="mico mico-home"></i>{$lang.homepage}</a></li>
			
			{if ! $logged_in}
			<li><a href="{$smarty.const._URL}/login.{$smarty.const._FEXT}"><i class="mico mico-perm_identity"></i>{$lang.sign_in|default:'Sign in'}</a></li>
				{if $logged_in != '1' && $allow_registration == '1'}
					{if $allow_facebook_login || $allow_twitter_login}
					<li><a class="primary ajax-modal" data-toggle="modal" data-backdrop="true" data-keyboard="true" href="#modal-register-form"><i class="mico mico-input"></i>{$lang.register}</a></li>
					{else}
					<li><a href="{$smarty.const._URL}/register.{$smarty.const._FEXT}"><i class="mico mico-input"></i>{$lang.register}</a></li>
					{/if}
				{/if}
			{else}
			<li><a href="{$current_user_data.profile_url}"><i class="mico mico-perm_identity"></i>{if $smarty.const._MOD_SOCIAL}{$lang.my_channel|default:'My Channel'}{else}{$lang.my_profile}{/if}</a></li>
			{/if}
		...
		{if $logged_in && count($s_user_playlists) > 4}
		<div class="navslide-header"><a href="{$smarty.const._URL}/playlists.{$smarty.const._FEXT}">{$lang.my_playlists}</a></div>
		<ul class="list-unstyled">
			{foreach from=$s_user_playlists key=k item=playlist_data}
		...
		<div class="navslide-header"><a href="{$smarty.const._URL}/{if $smarty.const._SEOMOD}browse.{$smarty.const._FEXT}{else}category.php{/if}">{$lang._categories}</a></div>
		<ul class="list-unstyled">
			...
			{dropdown_menu_video_categories max_levels=1}
			<li><a href="{if $smarty.const.USER_DEVICE != 'mobile'}{$smarty.const._URL}/{if $smarty.const._SEOMOD}browse.{$smarty.const._FEXT}{else}category.php{/if}{else}#{/if}">{$lang.show_more}</a></li>
		</ul>
		<div class="navslide-divider"></div>
...
<header class="pm-top-head">
	<div class="row">
		<div class="col-xs-7 col-sm-4 col-md-4">
			<a href="#" data-toggle="offcanvas" data-target="#myNavmenu" data-canvas="body" id="navslide-toggle"><span>{$lang.show_menu}</span></a>
		...
		<div class="col-xs-5 col-sm-4 col-md-4">
			<ul class="list-inline navbar-pmuser">
				...
				<li class="nav-menu-item">
					<div class="dropdown">
						<a href="#" data-toggle="dropdown" role="button" ><img src="{$s_avatar_url}" width="30" height="30" alt=""></a>
