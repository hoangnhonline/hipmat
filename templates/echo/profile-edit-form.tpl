<form class="form-horizontal" name="register-form" id="register-form" method="post" action="{$form_action}" role="form">
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-md-4"><input type="text" class="form-control" name="website" {if isset($inputs.website)}value="{$inputs.website}"{else}value="{$userdata.social_links.website}"{/if} placeholder="http://"></div>
    </div>
    <div class="form-group">
