				...
				<li class="col-sm-6 col-md-4">
					<div class="pm-channel">
						...
						<div class="pm-channel-body">
							<h3><a href="{$user_data.profile_url}" class="ellipsis {if $user_data.user_is_banned}pm-user-banned{/if}">{$user_data.name}</a> {if $user_data.is_following_me}<span class="label label-success label-follow-status pull-right">{$lang.subscriber|default:'Subscriber'}</span>{/if}</h3>
