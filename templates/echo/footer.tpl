	...
	<footer>
		<div class="row row-footer-vertical">
			...
			{if $smarty.const._MOD_ARTICLE == 1}
				<h3>{$lang.articles}</h3>
				<ul class="list-unstyled">
					<li><a href="{$smarty.const._URL}/article.{$smarty.const._FEXT}">{$lang.articles_latest}</a></li>
					<li><a href="{$smarty.const._URL}/article.{$smarty.const._FEXT}?show=popular">{$lang.articles_mostread}</a></li>
					<li><a href="{$smarty.const._URL}/rss.php?feed=articles" title="{$meta_title} RSS">RSS</a></li>
				</ul>
			{/if}
			</div>
			<div class="col-xs-4 col-sm-2 col-md-2">
				...
				<ul class="list-unstyled">
					...
					<li><a href="{$smarty.const._URL}/rss.php?c={$cat_id}" title="{$meta_title} RSS" rel="nofollow">RSS</a></li>
					{elseif $tpl_name == "video-new"}
					<li><a href="{$smarty.const._URL}/rss.php" title="{$meta_title} RSS" rel="nofollow">RSS</a></li>
					{elseif $tpl_name == "video-top"}
					<li><a href="{$smarty.const._URL}/rss.php?feed=topvideos" title="{$meta_title} RSS" rel="nofollow">RSS</a></li>
					{else}
					<li><a href="{$smarty.const._URL}/rss.php" title="{$meta_title} RSS" rel="nofollow">RSS</a></li>
					{/if}
				</ul>
...
<script src="{/literal}{$smarty.const._URL}/templates/{$template_dir}{literal}/js/jquery.dotdotdot.min.js" type="text/javascript"></script>
...
<script src="{/literal}{$smarty.const._URL}/templates/{$template_dir}{literal}/js/jquery.autosize.min.js" type="text/javascript"></script>
{/literal}
