...
<!-- Grid banner -->
    <div class="container-fluid">
      <div class="row-fluid">
        <div class="span8">
		<div id="primary">
			<h1 class="niceheading sameh2"><i class="fa fa-folder-o"></i> {$gv_category_name}</h1>
  ...
  <!-- googleads -->
        {if $ad_12!=""}
           ...
           <h2 class="upper-blue niceheading"><i class="fa fa-gamepad"></i> {$lang.googleads}</h2>
           <div class="googleads">
{$ad_12}
</div>
{/if}
        ...
        <div class="widget-related widget" id="pm-related" >
          ...
          <div id="pm-tabs" class="tab-content">
            <div class="tab-pane fade in active" id="bestincategory2">
                ...
                {get_advanced_video_list assignto="advanced_video_list" category_id=$cat_id order_by="site_views" days_ago=12 limit=6}
