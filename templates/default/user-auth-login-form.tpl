<form class="form-horizontal" name="login_form" id="login-form" method="post" action="{$smarty.const._URL}/login.php">
  <fieldset>
  ...
  <div class="control-group">
      <div class="controls">
        ...
        <input type="checkbox" name="remember" value="1" {if $smarty.post.remember} checked="checked"{/if}> <small>{$lang.remember_me}</small>
        </label>
      </div>
  </div>
